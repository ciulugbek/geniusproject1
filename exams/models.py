...
class ExamStudent(models.Model):
    ...
    class Meta:
        constraints = [
            UniqueConstraint('exam_id','student_id','exam_student_date',name='exam_student_date_unique',),
        ]
...
class ExamStudentResult(models.Model):
    ...
    class Meta:
        constraints = [
            UniqueConstraint('exam_student_id','student_group_id',name='exam_student_result_unique',),
        ]
